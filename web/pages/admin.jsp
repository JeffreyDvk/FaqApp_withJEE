...
<html lang="en">
    ...
    <body>
        ...
        <div id="top-nav">
            ...
            <a id="toggle-button"><i class="fa fa-align-justify"></i></a>
        </div>
        ...
        <div id="menu-bar" class="p-3">
            ...
            <div id="menu-list">
                <a href="admin.jsp?pages=gest" class="nav-link">Gérer la FAQ</a>
                <a href="admin.jsp?pages=faq" class="nav-link">Afficher la FAQ</a>
                <a href="admin.jsp?pages=messagerie" class="nav-link">Messagerie</a>
                <a class="deco nav-link">Déconnexion</a>
            </div>
        </div>
        <div class="" id="main-content">
            <c:choose>
                <c:when test="${param.pages == 'gest'}">
                    <%@include file="gest.jsp" %>
                </c:when>
                <c:when test="${param.pages == 'messagerie'}">
